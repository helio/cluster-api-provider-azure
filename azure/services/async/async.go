...
// ServiceWithUpdater is a Service with an additional updater. It implements the ReconcilerWithUpdate interface.
...
// NewWithUpdater creates an async ServiceWithUpdater.
...
// UpdateResource updates a resource asynchronously.
