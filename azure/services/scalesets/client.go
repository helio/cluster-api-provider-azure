...
// UpdateAsync updates a virtual machine scale set asynchronously.
// It sends a PATCH request to Azure and if accepted without error, the func will return a poller which can be used to track the ongoing
// progress of the operation.
